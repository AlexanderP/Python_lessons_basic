...
for i in lst:
    if i > 0:
        if math.sqrt(i).is_integer():
            lst_tmp.append(int(math.sqrt(i)))
print(lst_tmp)
...
day_dict = {'01': 'первое', '02': 'второе', '03': 'третье', '04': 'четвертое',
            ...
            '21': 'двадцать перов', '22': 'двадцать второе',
...
mounth_dict = {'01': 'января', '02': 'февраля', '03': 'марта', '04': 'апреля',
...
print(f'{day_dict[date[0]]} {mounth_dict[date[1]]} {date[2]} года')
...
tmp_lst = []
for i in lst:
    if lst.count(i) < 2 and i not in tmp_lst:
        tmp_lst.append(i)
print(tmp_lst)
